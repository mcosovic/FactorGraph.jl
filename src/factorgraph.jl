...
#	- dir: position of singly-connected factor according to variable nodes
#--------------------------------------------------------------------------
function links(Nf, T)
	Nld = 0
	Nli = 0
...
#	- bi: vector of measurement means of indirect factor nodes
...
#	- md: like means from singly-connected factors to variable nodes
#	- vid: inverse variance from singly-connected factors to variable nodes
#--------------------------------------------------------------------------
