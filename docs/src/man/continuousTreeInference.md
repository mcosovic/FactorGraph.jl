...
To exchange information over the tree factor graph, the FactorGraph provides forward–backward GBP algorithm. We advise the reader to read the Section [forward–backward message passing schedule] (@ref treeSchedule) which provides a detailed description of the inference algorithm.
